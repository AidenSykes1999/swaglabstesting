...
public class CheckoutStepDefs {
    ...
    public void iAmOnTheCheckoutStepOnePage() {
        checkoutStepOnePage = login.loginGoToInventoryPage("standard_user", "secret_sauce")
                .goToCart().goToCheckoutStepOne();
    ...
    public void iAmOnTheCheckoutStepTwoPage() {
        checkoutStepTwoPage = login.loginGoToInventoryPage("standard_user", "secret_sauce")
                .goToCart().goToCheckoutStepOne()
                .enterFirstName("Foo")
                .enterLastName("Bar")
    ...
    public void iHaveABackpackAndABikeLightInTheCart() {
        ...
        inventoryPage.addOrRemoveProductFromCart(0)
    ...
    public void iShouldHaveAnItemTotalOfThirtyNineNinetyEight() {
        System.out.println(checkoutStepTwoPage.getCurrentUrl());
        int actual = checkoutStepTwoPage.getItemTotalCents();
        System.out.println(actual);
        Assertions.assertEquals(3998, checkoutStepTwoPage.getItemTotalCents());
    }
